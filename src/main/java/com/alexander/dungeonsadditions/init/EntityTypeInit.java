...
public class EntityTypeInit {
	...
	public static final RegistryObject<EntityType<EliteEvokerEntity>> ELITE_EVOKER = ENTITY_TYPES.register("elite_evoker",
			() -> EntityType.Builder.of(EliteEvokerEntity::new, EntityClassification.MONSTER).sized(0.6F, 1.95F)
					.build(new ResourceLocation(DungeonsAdditions.MOD_ID, "elite_evoker").toString()));
	
	public static final RegistryObject<EntityType<TribagerEntity>> TRIBAGER = ENTITY_TYPES.register("tribager",
			() -> EntityType.Builder.of(TribagerEntity::new, EntityClassification.MONSTER).sized(0.6F, 1.95F)
					.build(new ResourceLocation(DungeonsAdditions.MOD_ID, "tribager").toString()));
	
	public static final RegistryObject<EntityType<TribagerChiefEntity>> TRIBAGER_CHIEF = ENTITY_TYPES.register("tribager_chief",
			() -> EntityType.Builder.of(TribagerChiefEntity::new, EntityClassification.MONSTER).sized(0.6F, 2.75F)
